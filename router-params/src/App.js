...
export default function App() {
  ...
  <Router>
    <h2>TV APPS</h2>
        <Link to ="/nertflix"><img className="nf" src="https://upload.wikimedia.org/wikipedia/commons/6/69/Netflix_logo.svg" alt="netflix"></img></Link>
        <Link to ="/hbomax"><img className="nb" src="https://upload.wikimedia.org/wikipedia/commons/1/17/HBO_Max_Logo.svg" alt="hbomax"></img></Link>
